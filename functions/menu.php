...
function joints_top_nav() {
	 wp_nav_menu(array(
        ...
        'menu_class' => 'menu vertical large-horizontal align-right',       // Adding custom nav class
...
function joints_footer_links() {
    wp_nav_menu(array(
    	...
    	'menu_class' => 'vertical menu align-center large-horizontal',      					// Adding custom nav class
